//Stacked area graph
//Followed Mike Bostock's work to find out how to do a basic stacked area: https://bl.ocks.org/mbostock/3885211
function drawArea() {
    ...
    d3.csv("/TotalByYearProportion1980Up.csv", type, function(error, data) {
